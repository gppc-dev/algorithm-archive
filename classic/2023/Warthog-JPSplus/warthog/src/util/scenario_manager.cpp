...
warthog::scenario_manager::load_scenario(const char* filelocation)
{
	...
	load_scenario(infile, filelocation);
	sfile_ = filelocation;
}

void 
warthog::scenario_manager::load_scenario(std::istream& infile, const char* filelocation)
{
	if(!infile.good())
	{
...
void 
warthog::scenario_manager::load_gppc_scenario(std::istream& infile)
{
