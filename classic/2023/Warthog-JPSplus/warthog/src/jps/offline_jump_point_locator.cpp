...
warthog::offline_jump_point_locator::offline_jump_point_locator(warthog::gridmap* map, const std::string& preFilename)
...
bool
warthog::offline_jump_point_locator::load(const char* filename, bool append)
{
	char fname[256];
...
void 
warthog::offline_jump_point_locator::save(const char* filename, bool append)
{
	char fname[256];
	strcpy(fname, filename);
	if (append)
