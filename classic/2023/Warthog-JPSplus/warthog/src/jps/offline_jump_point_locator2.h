...
class offline_jump_point_locator2
{
	public:
		...
		offline_jump_point_locator2(warthog::gridmap* map, const std::string& preFilename);
	...
	private:
		...
		bool
		load(const char* filename, bool append = true);

		void 
		save(const char* filename, bool append = true);
