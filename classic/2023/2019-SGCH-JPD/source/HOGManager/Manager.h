...
class ManagerBase {
 public:
  ...
  virtual void SinglePointQuery(SgchXyLoc l) = 0;
  virtual void DoublePointQuery(SgchXyLoc l1, SgchXyLoc l2) = 0;
...
class Manager : public ManagerBase {
 ...
 public:
  ...
  void SinglePointQuery(SgchXyLoc l);
  void DoublePointQuery(SgchXyLoc l1, SgchXyLoc l2);
 ...
 private:
  ...
  SgchXyLoc xy_start, xy_goal;
  int t_start, t_goal;
  int num_angles_;
  xyThetaPos xyt_start, xyt_goal;
  xyThetaPos GetXYThetaPos(SgchXyLoc l, int disc_orientation) {
  ...
  void SetStartXY(SgchXyLoc l) {
    xy_start = l;
    UpdateXYThetaPoses();
  }
  void SetGoalXY(SgchXyLoc l) {
    xy_goal = l;
    UpdateXYThetaPoses();
  }
  ...
  void SetStart(SgchXyLoc l) {
   SetStartXY(l);
  }
  void SetGoal(SgchXyLoc l) {
   SetGoalXY(l);
  }
  void SetStart(xyThetaPos p) {
    SetStartXY(SgchXyLoc(p.x, p.y));
    SetStartOrientation(p.o);
  }
  void SetGoal(xyThetaPos p) {
    SetGoalXY(SgchXyLoc(p.x, p.y));
