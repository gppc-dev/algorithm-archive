...
double OctileDistance(SgchXyLoc l1, SgchXyLoc l2);
double EuclideanDistance(SgchXyLoc l1, SgchXyLoc l2);
...
class OctileDistanceHeuristic {
 public:
  ...
  Distance GetHeuristicDistance(nodeId n1, nodeId n2) {
    return OctileDistance(g_->ToSgchXyLoc(n1), g_->ToSgchXyLoc(n2));
  }
