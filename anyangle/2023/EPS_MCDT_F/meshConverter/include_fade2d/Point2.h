...
* @param y_ y-coordinate
* @param z_ z-coordinate
* @param customIndex_ Arbitrary index_data, use -1 if not required
*
*/
...
/** \brief Set a custom index_data
*
* An arbitrary index_data can be assigned to a point. Use getCustomIndex()
...
* is optional. By default this index_data is -1.
*
...
/** \brief Get the custom index_data
*
* @return the custom index_data.
*
* @note The custom index_data defaults to -1. It is not the index_data of the point
* in the triangulation (such an index_data does not exist) but an arbitrary
