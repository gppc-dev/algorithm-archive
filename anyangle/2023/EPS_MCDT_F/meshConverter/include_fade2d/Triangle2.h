...
*
* @param ith is the intra-triangle-index_data, ith={0,1,2}.
*/
...
*
*
* @param ith is the intra-triangle-index_data of the opposite corner of @e *this
...
/** \brief Get the index_data of \e p in the triangle
*
* \image html getITI.jpg "Figure 4: Intra triangle index_data of a vertex pointer" width=10cm
* \image latex getITI.eps "Intra triangle index_data of a vertex pointer" width=4cm
*
* @param p is a pointer to a vertex in @e *this
*
* @return the intra-triangle-index_data 0,1 or 2 of @e p in @e *this
*
*
*/
	int getIntraTriangleIndex(const Point2* p) const;
/** \brief Get the neighbor index_data of \e pTriangle
*
*
...
*
* @return the intra-triangle-index_data of the vertex in \e *this which is opposite (i.e., does not
* touch the neighbor) \e pTriangle.
*/
	int getIntraTriangleIndex(const Triangle2* pTriangle) const;

/** \brief Get the index_data of \p (p0,p1)
*
* @return the index_data of the edge \p (p0,p1) in the triangle
*/
...
*
*
* @param ith is the index_data of the corner of \e *this which does not touch \e pTriangle
...
/** \brief Get the index_data of the largest edge
*/
	int getMaxIndex() const;

/** \brief Get the index_data of the smallest edge
*/
