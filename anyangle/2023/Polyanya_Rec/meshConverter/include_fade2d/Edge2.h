...
public:
	 ...
	 * @param oppIdx_ is intra-triangle-index_data of the opposite vertex (of the edge) in pT
	 *
	...
	*/
	 ...
	 * same intra-triangle-index_data.
	*/
	bool operator==(const Edge2& e) const
	{
	...
	*/
	 ...
	 * \param idx0 is the opposite intra-triangle-index_data in pT0 of the present edge
	 * \param pT1 is the other adjacent triangle at the present edge (or NULL)
	 * \param idx1 is the intra-triangle index_data of the present edge in pT1 (or -1)
	 *
	 */
