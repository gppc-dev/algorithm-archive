...
namespace polyanya
{
    ...
    public:
        ...
        void mark_turning_point(const vector<bool> &bits, int width, int height);

        void create_cpd_out_list(Graph g, const std::vector<int>& cpd_mapper);
        void create_cpd_to_vertices_mapper(vector<int> vertices_mapper, vector<int> cpd_mapper);
    };
